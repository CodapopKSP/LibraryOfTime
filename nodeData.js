...
const standardTimeData = [
  {
    ...
    confidence: "Exact",
    overview:
      "This is the current local time based on the timezone provided by your device.",
    info:
...
const computingTimeData = [
...

  {
    ...
    accuracy:
      `This clock is considered to be perfectly accurate, as it's a simple calculation from UTC.`,
    source:
...

  {
    ...
    source:
      'Much of the information for this clock came from <a href="http://www.leapsecond.com/java/gpsclock.htm">this website</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Gregorian_calendar">Wikipedia article</a>.',
  },

  {
    ...
    confidence: "Exact",
    overview:
      "The Julian Day Number is a simple count of number of days since 12:00 (noon) on November 24, 4713 BCE (or 4714 BCE when not using astronomical dates). The JDN is used by astronomers and programmers to simplify calculations for the passage of time, and many of the calculations in this website are based off of the JDN.",
    info:
      "There are many versions of the JDN, most of which involve truncating the large number for easier calculations.",
    accuracy:
      "This counter is rigorously-studied and exactly accurate, with the only question being the addition of Dynamical Time.",
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Julian_day">Wikipedia article</a>.',
  },

  {
    ...
    confidence: "Exact",
    overview:
      "Rata Die is similar to the Julian Day Number and is a simple count of number of days in the Gregorian Calendar since January 1st, 1 CE.",
    info:
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Rata_Die">Wikipedia article</a>.',
  },

  {
    ...
    confidence: "High",
    overview:
      "The Julian Period is a cycle of 7980 years beginning in the year 4712 BCE (or 4713 BCE when not using astronomical dates). It is used by historians to date events when no calendar date is given or when previous given dates are deemed to be incorrect.",
    info:
      "The Julian Period is the count of days since the last time Indiction, Solar and Lunar cycles all started on the same day.",
    accuracy:
      "The Julian Period is a simple count of days, meaning it should be exactly accurate. However, I have had some difficulty ensuring this counter is perfectly calibrated.",
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Julian_day">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Lilian_date">Wikipedia article</a>.',
  },

  {
    ...
    confidence: "Exact",
    overview:
      "ISO 8601 is the standard of displaying date and time provided by the International Organization for Standardization. It is based off the Gregorian calendar.",
    info:
    ...
    source:
      `ISO 8601 is actually a supported string of JavaScript's native Date library, so there is nothing for this website to calculate. General information came from its <a href="https://en.wikipedia.org/wiki/ISO_8601">Wikipedia article</a>.`,
  },

  {
    ...
    confidence: "Medium",
    overview:
      "Dynamical Time is an approximation of the difference in time due to various factors that affect Earth's orbit, such as gravitational effects from other planets. It matches UTC at around the year 1880 and deviates the further away in time as a parabolic equation, with an uncertainty as much as two hours by the year 4000 BCE.",
    info:
      "The exact time of the year is slowly changing on the order of a few seconds per year. This rate is not constant, though it can be estimated.",
    accuracy:
      `Dynamical Time is itself an approximation, so the results here can only be as good as that approximation. Unfortunately, there seems to be a bit of induced error on top of that, as my solutions don't exactly match those provided by Meeus. This could be due to JavaScript's base-2 calculation or due to a misunderstanding in some of the steps.`,
    source:
      'This calculation was sourced from <a href="https://archive.org/details/astronomicalalgorithmsjeanmeeus1991/page/n7/mode/2up"><i>Astronomical Algorithms</i> (1991)</a> by Jean Meeus.',
  },

  {
    ...
    accuracy:
      "This clock should be very accurate, though I am unsure how Dynamical Time factors into it, which could cause it to be off by a few minutes.",
    source:
      `All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Timekeeping_on_Mars">Wikipedia article</a>.`,
  },
...
const decimalTimeData = [
  {
    ...
    accuracy:
      "As this is a simple mathematical calculation, this clock is exactly accuerate.",
    source:
      'All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Decimal_time">Wikipedia article</a>.',
  },

  {
    ...
    confidence: "Exact",
    overview:
      ".beat time, also known as Swatch Internet Time, is a timekeeping system developed in 1998 by the Swatch corporation. It divides the day into 1000 equal parts, called .beats, and is set to the BMT timezone (UTC +2).",
    info:
    ...
    accuracy:
      "As this is a simple mathematical calculation, this clock is exactly accuerate.",
    source:
      'All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Swatch_Internet_Time">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      "As this is a simple mathematical calculation, this clock is exactly accuerate.",
    source:
      'All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Gregorian_calendar">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      "As this is a simple mathematical calculation, this clock is exactly accuerate.",
    source:
      'All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Binary_clock">Wikipedia article</a>.',
  },
];
...
const otherTimeData = [
  {
    ...
    accuracy:
      "This clock should be reasonably accurate, though it might be off by a feww minutes or seconds due to Dynamical Time.",
    source:
      `All of the information on this clock came from its <a href="https://en.wikipedia.org/wiki/Timekeeping_on_Mars">Wikipedia article</a>.`,
  },
];
...
const solarCalendarsData = [
...

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Julian_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/French_Republican_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Era_Fascista">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Coptic_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Ethiopian_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Republic_of_China_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Thai_solar_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Juche_calendar">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      "The Byzantine calendar is intrinsically based on and locked to the Julian calendar, making it perfectly accurate.",
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Byzantine_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Florentine_calendar">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      "The accuracy of this calendar depends on the equinox calculations and may be off by a day for a whole year, but it is likely to self-correct by the next year. The equation breaks down considerably if rolled back or forward several thousand years as the equinox drifts due to precession and Dynamical Time invokes inaccuracies.\n\nThe sunset approximation is also likely to cause slight inaccuracies if the New Moon happens very near to sunset, though this is similarly likely to self-correct by the next year. On that note, the dates may change slightly too early or late depending on the real time of sunset.",
    source:
      'A lot of the information about this calendar came from its <a href="https://en.wikipedia.org/wiki/Bah%C3%A1%CA%BC%C3%AD_calendar">Wikipedia article</a>.\n\nDates can be referenced at the <a href="https://www.bahai.org/action/devotional-life/calendar">official Baháʼí website</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/%27Pataphysics#Pataphysical_calendar">Wikipedia article</a>.',
  },

  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Discordian_calendar">Wikipedia article</a>.',
  },
];
...
const lunisolarCalendarsData = [
  {
    ...
    accuracy:
      "Calculating this calendar is very difficult and requires calculating the Winter Solstice, Spring Equinox, Longitude of the Sun, and any given New Moon. Due to the difficulty of this calculation, months and days might be off by 1 at times, though they typically self-correct by the next month.",
    source:
      'This equation was based off of the steps found <a href="https://ytliu0.github.io/ChineseCalendar/rules.html">here</a>.\n\nGeneral information was taken from the <a href="https://en.wikipedia.org/wiki/Chinese_calendar">Wikipedia article</a> for this calendar.',
  },

  {
    ...
    accuracy:
      "This calendar system should be very accurate. At most it will be off by a few days at the start of a given year due to the inaccuracies from the Chinese lunisolar calendar calculations. However, it quickly corrects itself after a few days.",
    source:
      'Some general information was taken from the <a href="https://en.wikipedia.org/wiki/Sexagenary_cycle">Wikipedia article</a> for this calendar, but the general calculation is derived from the Chinese lunisolar calendar.',
  },

  {
    ...
    source:
      'Some general information was taken from the <a href="https://en.wikipedia.org/wiki/Vietnamese_calendar">Wikipedia article</a> for this calendar, but the general calculation is derived from the Chinese lunisolar calendar.',
  },

  {
    ...
    accuracy: "calendar accuracy",
    source:
      'Some general information was taken from the <a href="https://en.wikipedia.org/wiki/Korean_calendar">Wikipedia article</a> for this calendar, but the general calculation is derived from the Chinese lunisolar calendar.',
  },
...
const lunarCalendarsData = [
  {
    ...
    source:
      'A lot of the information about this calendar came from its <a href="https://en.wikipedia.org/wiki/Islamic_calendar">Wikipedia article</a>.\n\n<a href="https://www.islamicfinder.org/islamic-calendar/">This site</a> seems to be a good source for callibrating dates.',
  },
];
...
const proposedCalendars = [
  {
    ...
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Holocene_calendar">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      `As this calendar is only a proposal, there really isn't anything to compare it to historically. It is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.`,
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/Invariable_Calendar">Wikipedia article</a>.',
  },

  {
    ...
    accuracy:
      `As this calendar is only a proposal, there really isn't anything to compare it to historically. It is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.`,
    source:
      'All of the information on this calendar came from its <a href="https://en.wikipedia.org/wiki/World_Calendar">Wikipedia article</a>.',
  },
];
...
const astronomicalData = [
...

  {
    ...
    confidence: "High",
    overview:
      "This is the approximate time of the New Moon, also known as a Lunar Conjunction, of the current month. It is an important event in many cultures, and most lunar or lunisolar calendars use the New Moon as the beginning of the month.",
    info:
      "Calculating the New Moon is no easy task. It involves several steps and different tables of equations, and it is likely the most resource-taxing calculation on this site. Unfortunately it also must be calculated several times due to the nature of lunar calendars, though the date shown here is resused when possible. New Moons are on average 29.53059 days apart, but that number can vary by several hours in a given cycle due to the shape of the moon's orbit as well as other gravitational effects. Thus, it is often necessary to calculate each New Moon directly.",
    accuracy:
      "This calculation is <i>mostly</i> accurate, but it differs from Jean Meeus's solutions by a few minutes. I am not sure why this is the case, though I suspect it has to do with the base-2 calculations in JavaScript. It is also possible that my Dynamical Time calculations are independently incorrect, which are factored into the New Moon calculation. Dates far away from the current year are likely to be significantly off.",
    source:
      'This calculation in its entirety was sourced from <a href="https://archive.org/details/astronomicalalgorithmsjeanmeeus1991/page/n7/mode/2up"><i>Astronomical Algorithms</i> (1991)</a> by Jean Meeus.',
  },
];
...
const popCultureData = [
  {
    ...
    source:
      'This calculation was sourced from <a href="https://minecraft.fandom.com/wiki/Daylight_cycle">the Minecraft Fandom Wiki</a>.',
  },

  {
    ...
    source:
      'This calculation was sourced from the movie <a href="https://en.wikipedia.org/wiki/Inception">Inception</a>.',
  },
];
...
const politicalCycles = [
  {
    ...
    source:
      'The data for this entry was sourced from <a href="https://en.wikipedia.org/wiki/List_of_presidents_of_the_United_States">this Wikipedia page</a>.',
  },
];
