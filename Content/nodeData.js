...
const solarCalendarsData = [
...

    {
        ...
        confidence: `Exact`,
        overview: `The Ge'ez calendar is the official calculated solar calendar of Ethiopia. It has 12 months of 30 days plus a smaller 13th month of 5 or 6 days. It has a leap day every 4 years, keeping it in sync with the Julian calendar while sharing months and days with the Coptic calendar.\n\nThe New Year starts on September 11th or 12th, with years abbreviated with ዓ.ም. which is pronounced 'am', short for Amätä Mihret, meaning 'Year of Mercy'.`,
...

    {
        ...
        confidence: `Exact`,
        overview: `The Thai solar calendar is a Gregorian-based calendar used in Thailand. It is 543 years ahead of the Gregorian calendar, though it shares the same months with different names.\n\nIt represents the number of years of the current Buddhist Era (B.E.), the Era of the Shaka Buddha. Year 0 falls on the Gregorian year of 543 BCE.`,
...

    {
        ...
        confidence: `Exact`,
        overview: `The Juche calendar is a Gregorian-based calendar used in North Korea. It represents the number of years since the birth year of Kim Il Sung, the founder of the DPRK, and was adopted in 1997. For its months and days it follows the Gregorian calendar.`,
...

    {
        ...
        confidence: `Exact`,
        overview: `Anno Lucis is a Gregorian-based date numbering system used by the Freemasons. It is computed by adding 4000 to the current Gregorian year, and otherwise shares its other components.\n\nYears are denoted with 'AL', which stands for Anno Lucis, meaning "in the Year of Light". This refers to the proposed year of creation from the Hebrew calendar.`,
        info: ``,
