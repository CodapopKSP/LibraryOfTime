...
const computingTimeData = [
...

    {
        ...
        accuracy: `This clock relies on the ΔT calculations, which are only approximations. On top of that, they were created in the 1990s are are certainly out of date by a few seconds.<h3>Dependencies</h3><ul><li>ΔT</li></ul>`,
...

    {
        ...
        accuracy: `This clock should be very accurate, though it relies on ΔT which ultimately is only an approximation.<h3>Dependencies</h3><ul><li>ΔT</li></ul>`,
...

    {
        ...
        info: `One Mars sol is 39 minutes and 35 seconds longer than an Earth day.`,
        accuracy: `This clock should be very accurate, though there are some very minor inaccuracies likely stemming from the redefiniton of the epoch of the Mars Sol Day, or perhaps slight differences in calculations of ΔT.<h3>Dependencies</h3><ul><li>ΔT</li><li>Mars Sol Day</li></ul>`,
...
const solarCalendarsData = [
...

    {
        ...
        info: `<table class="table-very-very-long"><tr><th>Month</th><th>Days</th></tr><tr><td>January</td><td>31</td></tr><tr><td>February</td><td>28 or 29</td></tr><tr><td>March</td><td>31</td></tr><tr><td>April</td><td>30</td></tr><tr><td>May</td><td>31</td></tr><tr><td>June</td><td>30</td></tr><tr><td>July</td><td>31</td></tr><tr><td>August</td><td>31</td></tr><tr><td>September</td><td>30</td></tr><tr><td>October</td><td>31</td></tr><tr><td>November</td><td>30</td></tr><tr><td>December</td><td>31</td></tr></table>`,
        accuracy: `This calendar is a simple calculation and is considered to be exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `This calendar depends on the accuracy of the equinox calculations, which are generally within a few minutes of accuracy and should only affect years where the equinox happens very close to midnight CET.\n\nThe French Republican calendar also had some issues with rules that contracticted each other, like a 4 year leap year rule conflicting with the date of the equinox. That rule has been ignored in favor of the equinox rule.<h3>Dependencies</h3><ul><li>Autumn Equinox</li></ul>`,
...

    {
        ...
        accuracy: `Era Fascista is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `The Coptic calendar is intrinsically based on and locked to the Julian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `The Ge'ez calendar is intrinsically based on and locked to the Julian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `The Minguo calendar is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `The Thai solar calendar is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `This calendar is intrinsically tied to the Gregorian calendar and is exactly accurate. However, it does have an alternate rule set used in India that is not present here.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `The Juche calendar is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `The Byzantine calendar is intrinsically based on and locked to the Julian calendar, making it perfectly accurate. However, there is some confusion as to when the day actually begins, with sources seemingly contradicting each other.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `The Florentine calendar is intrinsically based on and locked to the Julian calendar, making it perfectly accurate. The only inaccuracies are the differences in the approximation of sunset to the actual time of sunset, which is expected to only differ by a few hours or minutes per day.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        info: `<table class="table-very-very-long"><tr><th>Months</th><th>Days</th></tr><tr><td>March (25th - 31st)</td><td>7</td></tr><tr><td>April</td><td>30</td></tr><tr><td>May</td><td>31</td></tr><tr><td>June</td><td>30</td></tr><tr><td>July</td><td>31</td></tr><tr><td>August</td><td>31</td></tr><tr><td>September</td><td>30</td></tr><tr><td>October</td><td>31</td></tr><tr><td>November</td><td>30</td></tr><tr><td>December</td><td>31</td></tr><tr><td>January</td><td>31</td></tr><tr><td>February</td><td>28 or 29</td></tr><tr><td>March (1st - 24th)</td><td>24</td></tr></table>`,
        accuracy: `This calendar is based on the Julian calendar and is considered to be exactly accurate.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `The Pataphysical calendar is based off the Gregorian calendar and is thus exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `The Discordian calendar is based off the Gregorian calendar and is thus exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `As this calendar is based off the Gregorian calendar, this calculation is exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `Being an ISO standard with a standard calculation, this calendar is expected to be perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        info: ``,
        accuracy: `As this is a simple addition to the Gregorian calendar, this calculation is exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `As this calendar is intrinsically locked to the Gregorian calendar, this calculation is exactly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...

    {
        ...
        accuracy: `This calendar is a simple calculation, but it relies on the calculation for the Longitude of the Sun which has a tiny amount of error.<h3>Dependencies</h3><ul><li>Longitude of the Sun</li></ul>`,
...

    {
        ...
        accuracy: `This calendar is a simple cycle, though it relies on the calculation for the Longitude of the Sun which has a tiny bit of error.<h3>Dependencies</h3><ul><li>Longitude of the Sun</li></ul>`,
...
const lunisolarCalendarsData = [
    {
        ...
        accuracy: `Calculating this calendar is very difficult and requires calculating the Winter Solstice, Longitude of the Sun, and any given New Moon. Due to the difficulty of this calculation, months and days might be off by 1 at times, though they typically self-correct by the next month. Rarely, the leap month may be incorrect, especially in cases where the new moon and solstice happen on the same day.<h3>Dependencies</h3><ul><li>New Moon</li><li>Winter Solstice</li><li>Longitude of the Sun</li></ul>`,
...
const proposedCalendars = [
    {
        ...
        accuracy: `As this calendar is only a proposal, there really isn't anything to compare it to historically. It is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...
const otherCalendars = [
...

    {
        ...
        accuracy: `The Yuga Cycle is ultimately based off the Gregorian calendar via the Kali Ahargaṅa and is considered to be very accurate compared with historical records.<h3>Dependencies</h3><ul><li>Kali Ahargana</li></ul>`,
...

    {
        ...
        accuracy: `The exact start of the Olympic games is unclear, and most sources will just say it was held in the summer of 776 BCE. This website uses astronomical dates, so it is displayed here as 775 BCE. I have chosen to use 1 August of the Julian calendar for the middle of summer.<h3>Dependencies</h3><ul><li>Julian</li></ul>`,
...

    {
        ...
        accuracy: `This calendar system should be very accurate. It may be off by a few days at the start of a given year, or rarely an entire month, due to the inaccuracies from the Chinese lunisolar calendar calculations. However, it corrects itself by the next new moon.<h3>Dependencies</h3><ul><li>Chinese</li></ul>`,
...
const astronomicalData = [
...

    {
        ...
        accuracy: `The accuracy of this calculation depends on the precision of Meeus's calculations, which should be very accurate.<h3>Dependencies</h3><ul><li>ΔT</li></ul>`,
        source: `<h3>Primary Sources</h3>This calculation was sourced from <a href="https://archive.org/details/astronomicalalgorithmsjeanmeeus1991/page/n7/mode/2up">Astronomical Algorithms (1991)</a> by Jean Meeus.`
    },
...

    {
        ...
        type: `Astronomical Data`,
        epoch: `Next First Quarter Moon`,
        confidence: `High`,
        associatedWith: ``,
        overview: `This is the approximate time of the next First Quarter Moon after the selected date.\n\nA First Quarter Moon is when the Eastern half of the moon is in sunlight from the perspective of Earth.`,
...

    {
        ...
        type: `Astronomical Data`,
        epoch: `Next Last Quarter Moon`,
        confidence: `High`,
        associatedWith: ``,
        overview: `This is the approximate time of the next Last Quarter Moon after the selected date.\n\nA Last Quarter Moon is when the Western half of the moon is in sunlight from the perspective of Earth.`,
...

    {
        ...
        accuracy: `This calculation is reasonably accurate (to within seconds or minutes) for thousands of years before and after the year 2000 CE. Outside of that, errors are induced which can grow from hours to even days.\n\nThis calculation relies on the Full Moon calculation as well as Terrestrial Time, each of which have potential to induce these errors.<h3>Dependencies</h3><ul><li>ΔT</li><li>Full Moon</li></ul>`,
        source: `<h3>Primary Sources</h3>This calculation in its entirety was sourced from <a href="https://archive.org/details/astronomicalalgorithmsjeanmeeus1991/page/n7/mode/2up">Astronomical Algorithms (1991)</a> by Jean Meeus.\n\nThis cycle can be calibrated using the ephemerides at <a href="https://astropixels.com/ephemeris/phasescat/phasescat.html">this website</a>.`
    }
];
...
const popCultureData = [
...

    {
        ...
        accuracy: `Since this calendar is a simple mapping to the Gregorian calendar, it is perfectly accurate.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
...
const politicalCycles = [
    {
        ...
        accuracy: `US terms don't always start on January 20th, with certain stipulations such as if the 20th falls on a Sunday that could change the date slightly. The current system of terms starting on the 20th didn't start until 1937, and previously it was March 4th, with George Washington starting on April 30th.<h3>Dependencies</h3><ul><li>Gregorian</li></ul>`,
