...
const proposedCalendars = [
...

    {
        ...
        accuracy: `As this calendar is only a proposal, there really isn't anything to compare it to historically. It is intrinsically based on and locked to the Gregorian calendar, making it perfectly accurate.`,
        source: `<h3>Common Source</h3><a href="https://en.wikipedia.org/wiki/Positivist_calendar">Wikipedia article</a><h3>Primary Sources</h3>`
    },

    {
        ...
        source: `All of the information on this calendar came from <a href="https://www.hermetic.ch/cal_stud/nlsc/nlsc.htm">this website</a>.`
    },

    {
        ...
        source: `The information for this calendar came from <a href="https://hermetic.ch/cal_stud/palmen/yerm1.htm">this Hermetic Systems page</a>.`
    }
];
...
const otherCalendars = [
...

    {
        ...
        source: `<h3>Common Source</h3><a href="https://en.wikipedia.org/wiki/Yuga_cycle">Wikipedia article</a><h3>Primary Sources</h3>`
    },

    {
        ...
        source: `<h3>Common Source</h3><a href="https://en.wikipedia.org/wiki/Sothic_cycle">Wikipedia article</a><h3>Primary Sources</h3>`
    },
...

    {
        ...
        source: `Much of the information in this calendar came from its <a href="https://en.wikipedia.org/wiki/Japanese_calendar">Wikipedia page</a>.\n\nThe <a href="https://eco.mtk.nao.ac.jp/cgi-bin/koyomi/caldb_en.cgi">National Astronomical Observatory of Japan (NAOJ)</a> maintains a searchable table of ephemeris dates of the Japanese calendar throughout history and can be used for calibration or comparison.`
    },
