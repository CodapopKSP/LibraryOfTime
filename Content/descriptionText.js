const welcomeDescription = [
    {
        about: `Welcome to the Library of Time!\n<i>Created by CodapopKSP.</i>\n\nClick a calendar or clock for more info. You may input a date and time above. Make sure they follow the correct format:\n\n<table><tr><th>[Year-Month-Day] [Hour:Minute:Second]</th></tr><tr><td><i>Example: 2024-04-08 | 18:20:46\n(8 April 2024 CE at 18:20:46)</i></td></tr><table>\nTo restart the current time ticker, click the reset (⟲) button.\n\nIf you have any other interesting ideas or ways to tell time in recurring cycles, please let me know!\n\nYou may access the source code of this website <a href="https://github.com/CodapopKSP/LibraryOfTime">here</a>. Feel free to contact me on <a href="https://github.com/CodapopKSP">GitHub</a> or on <a href="https://old.reddit.com/user/CodapopKSP/">Reddit</a> for any questions, ideas, or offers of help. You can also join the <a href="https://discord.gg/AWjSachwPU">Discord channel</a> for this project or email me at  <a href="mailto:untitledspacecraft.controllers@gmail.com">untitledspacecraft.controllers@gmail.com</a>.\n\nIn particular, I need help with:\n<ul><li>Improving astronomical calculations</li><li>Providing historical insights, especially for Aztec, Roman, Vietnamese, Chinese, Indian, and Japanese calendars</li></ul>`,

        mission: '<h4>The Solar Eclipse of 8 April 2024</h4>After seeing the total solar eclipse of 8th April 2024 CE, I became interested in the fantastic ability of the math and astronomy used to calculate its time and location.\n\nI considered how such an event might have appeared to people in ancient times; they apparently found it as incredible as I did, because through my reading I was fascinated to hear that many ancient calendars were calibrated to modern calendars by the writings of eclipses by ancient peoples.<h4>The Mission of the Library of Time</h4>The mission of this website is to create a collection of every calendar with a verifiable date at a specific point in time, as well as other methods of timekeeping. It is to be a celebration of time as counted by humans from all walks of life, displaying all of the unique ways different people chose to satisfy one of humanity\'s earliest and most universal curiosities.\n\nAlso included in this mission is the calculation of celestial phenomena, just as those who calculated the dates and times of the eclipse allowed me to know in advance of the event that would inspire me.<h4>Technical Constraints</h4>Currently my goal is to build this page and its calculations with simple HTML and JavaScript, utilizing few or no external libraries nor APIs and making it easy to duplicate and run locally. In the future I may add an API so that others may access the data here for their own projects.',

        accuracy: `It is no secret that working with dates and times in computing is no easy task. You can refer to <a href="https://www.youtube.com/watch?v=-5wpm-gesOY">this famous video by YouTuber Tom Scott</a> for a deeper explanation.\n\nThis website uses the proleptic Gregorian calendar with Year 0 for all of its calculations and other info such as epochs. For that reason, you may notice that the displayed date or epoch is one year off from what a source might tell you, or several days if they're using the Julian or Astronomical calendars.\n\nFor many of the calendars, particularly lunar calendars that start at sunset at a particuilar location, I have opted to use 18:00 of that location as an approximation for sunset. Thus, it is certain that some observational calendars will temporarily be out of alignment when a new moon or other astronomical event occurs very near sunset.\n\nMost calendars have gone through various changes throughout history, which typically is not shown on this website. This can lead to the displayed calendars not matching historical records.\n\nAnd finally, some of the calculations are just very difficult or require mathematical approximations. ΔT in particular is just an approximation of how much the Earth\'s orbit and rotation are affected by the rest of the universe, which can lead to calculations such as the New Moon to be off by a significant margin the further away from the current day you go.\n\nThese reasons are why I do not suggest using this website as a primary source. However, the calculations here represent several hundred hours of study, calibration, and testing. If you notice an error, please do not hesitate to tell me.`,

        sources: `There are two kinds of sources for many of the entries on this site: sources of initial calculations and, in the case of calendars still in use, sources of calibration, such as a website displaying the current date of a particular calendar. When applicable, both will be listed in the Source tab of each entry.\n\nWhen necessary, I have made guesses and approximations, either because I wasn\'t able to locate the information, the information doesn\'t exist even at an academic level, or for the sake of reasonable simplicity. These will be noted in the Accuracy tabs.\n\nA lot of the information on this site comes from Wikipedia, but when necessary I have had to seek better, more informative, or more complete sources.<h4>Notable Sources</h4>The underlying astronomical calculations have come from <i>Astronomical Algorithms</i> (1991) by Jean Meeus. You can find a full text archive of the first edition <a href="https://archive.org/details/astronomicalalgorithmsjeanmeeus1991/page/n7/mode/2up">here</a>, though the second edition isn't available for free online.\n\nAnother major source is <a href="https://www.hermetic.ch/cal_stud.htm">Hermetic Systems</a> and its web of sites that it shares links with.`
    },
]
