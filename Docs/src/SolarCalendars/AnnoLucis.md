...
Anno Lucis is a Gregorian-based date numbering system used by the Freemasons. It is computed by adding 4000 to the current Gregorian year, and otherwise shares its other components.
