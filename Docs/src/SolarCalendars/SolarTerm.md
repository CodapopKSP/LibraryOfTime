...
| 210 | Autumn | Dog (戌) | 霜降 (Shuāngjiàng) | major |
| 225 | Winter | Pig (亥) | 立冬 (Lìdōng) | minor |
| 240 | Winter | Pig (亥) | 小雪 (Xiǎoxuě) | major |
| 255 | Winter | Rat (子) | 大雪 (Dàxuě) | minor |
| 270 | Winter | Rat (子) | 冬至 (Dōngzhì) | major |
