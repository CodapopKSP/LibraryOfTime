...
- **Docs info tables**: Use the `docs-info-tables` skill in `.cursor/skills/docs-info-tables/` when adding or standardizing month, day-name, weekday, or epoch tables in `Docs/src`.
