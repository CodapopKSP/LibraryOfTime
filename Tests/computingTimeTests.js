...
function testTerrestrialTime() {
    return runComputingTests("ΔT", getDeltaT, [
        ...
        ["1960-1-1, 00:00:00", "UTC+00:00", 33.10343421782085],    // pre-1972: Espenak–Meeus polynomial
        ["2000-1-1, 00:00:00", "UTC+00:00", 64.184],               // leap-second era: 32.184 + (TAI − UTC)
        ["2017-1-1, 00:00:00", "UTC+00:00", 69.184],
        ["2034-12-31, 00:00:00", "UTC+00:00", 69.184],
        ["2035-1-1, 00:00:00", "UTC+00:00", 69.184],               // rebased polynomial is continuous at the cutoff
        ["2036-1-1, 00:00:00", "UTC+00:00", 69.90298899999999],
    ]);
}
...
function testMarsSolDate() {
    return runComputingTests("Mars Sol Date", getMarsSolDate, [
        ...
        ["2000-1-1, 00:00:00", "UTC+00:00", 44791.133538913906],
    ]);
}
...
function testJulianSolNumber() {
    return runComputingTests("Julian Sol Number", getJulianSolDate, [
        ...
        ["2025-7-21, 00:00:00", "UTC+00:00", 148003.4226106495],
    ]);
}
