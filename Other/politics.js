...
export function getCurrentPresidentialTerm(currentDateTime) {
    ...
    january1789 = utilities.getMidnightInUTC(january1789, 16);
    let yearsSinceEpoch = currentDateTime.getFullYear()-epochYear;
    if (currentDateTime<januaryThisYear) {
        yearsSinceEpoch-=1;
    }
    let currentPresidentialTerm = utilities.differenceInDays(currentDateTime, january1789)/365.25/4;
